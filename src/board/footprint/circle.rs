...
#[serde(deny_unknown_fields, rename = "fp_circle")]
pub struct Circle {
...
mod tests {
	...
	sexpr_test_case! {
		name: circle,
		input: r#"(fp_circle (center 1 1) (end 2 2) (layer "F.SilkS") (width 0.12) (tstamp "00000000-0000-0000-0000-000000000000"))"#,
		value: Circle {
	...
	sexpr_test_case! {
		name: circle_filled,
		input: r#"(fp_circle (center 1 1) (end 2 2) (layer "F.SilkS") (width 0.12) (fill solid) (tstamp "00000000-0000-0000-0000-000000000000"))"#,
		value: Circle {
			center: Point::new(1.0.mm(), 1.0.mm()),
			end: Point::new(2.0.mm(), 2.0.mm()),
			layer: Layer::new("F.SilkS"),
